  ...
  try {
    ...
    const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        temperature: 0,
        messages: [
          { role: "system", content: "Ты преобразуешь описание еды в JSON. Верни только объект вида {\"items\":[{\"name\":\"название продукта по-русски\",\"grams\":число}]}. Не считай калории. Если указаны штуки, оцени массу съедобной части в граммах. Не добавляй продукты, которых нет в тексте. Готовые крупы и макароны считай варёными, если пользователь не уточнил иное." },
